// src/app/[locale]/editorial/page.tsx
...
export default async function EditorialBoard({
  ...
  // Strapi-аас locale-тэй өгөгдөл татах
  const members: EditorialMember[] = await getEditorialMembers(locale) || [];
      ...
      <div className="container mx-auto px-6 max-w-7xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {members.length > 0 ? (
            ...
            <p className="col-span-full text-center text-slate-500">{t('noData')}</p>
          )}
        </div>
      </div>
    </div>
